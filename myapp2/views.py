...
class PostCreate(LoginRequiredMixin,CreateView):
    model = Post
    form_class = PostForm
    success_url = reverse_lazy('myapp2:index')
    ...
    def get_success_url(self):
        ...
        return resolve_url('myapp2:index')
...
class PostUpdate(OnlyMyPostMixin,UpdateView):
    ...
    def get_success_url(self):
        ...
        return resolve_url('myapp2:post_detail', pk=self.kwargs['pk'])
...
class Logout(LogoutView):
    template_name = 'myapp2/logout.html'
    

class SignUp(CreateView):
    form_class = SignUpForm
    template_name = 'myapp2/signup.html'
    success_url = reverse_lazy('myapp2:index')
...
def Like_add(request, post_id):
    ...
    if is_liked > 0:
        ...
        return redirect('myapp2:post_detail',post_id)
    like = Like()
    ...
    return redirect('myapp2:post_detail', post.id)
...
def Search(request):
    if request.method == 'POST':
        ...
        return render(request,'myapp2/search.html',params)
